...
<%
    ...
    PostulacionHogarTemporal postulacionHogarTemporal = usuario.getUltima_postulacion_hogar_temporal();
                    ...
                    <form action="TemporalUsuarioServlet?action=modificar&id_postulacion=<%= postulacionHogarTemporal.getId_postulacion_hogar_temporal() %>" method="POST" style="margin-bottom: 0;" enctype="multipart/form-data">
                        <div class="row gtr-uniform">
                            ...
                            <div class="col-6 col-12-xsmall">
                                ...
                                <input type="text" name="edad" id="edad" value="<%= postulacionHogarTemporal.getEdad_usuario() %>" required />
                            </div>
                            <div class="col-6 col-12-xsmall">
                                <label for="genero" class="input-label">Género</label>
                                <select name="genero" id="genero" required>
                                    <option value="">Seleccione su género</option>
                                    <option value="Masculino" <%="Masculino".equals(postulacionHogarTemporal.getGenero_usuario())?"selected":""%> >Masculino</option>
                                    <option value="Femenino" <%="Femenino".equals(postulacionHogarTemporal.getGenero_usuario())?"selected":""%>>Femenino</option>
                                    <option value="Prefiero no decirlo" <%="Prefiero no decirlo".equals(postulacionHogarTemporal.getGenero_usuario())?"selected":""%>>Prefiero no decirlo</option>
                                </select>
                            </div>

                            <div class="col-6 col-12-xsmall">
                                <label for="telefono" class="input-label">Número de teléfono</label>
                                <input type="text" name="telefono" id="telefono" value="<%= postulacionHogarTemporal.getCelular_usuario() %>" required />
                            </div>
                            <div class="col-6 col-12-xsmall">
                            ...
                            <div class="col-6 col-12-xsmall">
                                ...
                                <input type="text" name="cuartos" id="cuartos" value="<%= postulacionHogarTemporal.getCantidad_cuartos() %>" required />
                            </div>
                            <div class="col-6 col-12-xsmall">
                                <label for="metraje" class="input-label">Metraje de vivienda (m&sup2)</label>
                                <input type="text" name="metraje" id="metraje" value="<%= postulacionHogarTemporal.getMetraje_vivienda() %>" required>
                            </div>
                            ...
                            <div class="col-6 col-12-xsmall">
                                ...
                                <select id="tieneHijo" name="tieneHijo" required>
                                    ...
                                    <option value="1" <%= postulacionHogarTemporal.getTiene_hijos() ? "selected" : "" %>>Sí tengo hijos</option>
                                    <option value="2" <%= !postulacionHogarTemporal.getTiene_hijos() ? "selected" : "" %>>No tengo hijos</option>
                                </select>
                            </div>
                            <div class="col-6 col-12-xsmall">
                                ...
                                <select id="tieneMascota" name="tieneMascota" required>
                                    <option value="">Seleccione su respuesta</option>
                                    <option value="1" <%= postulacionHogarTemporal.getTiene_mascotas() ? "selected" : "" %>>Sí tengo mascotas</option>
                                    <option value="2" <%= !postulacionHogarTemporal.getTiene_mascotas() ? "selected" : "" %>>No tengo mascotas</option>
                                </select>
                            </div>
                            ...
                            <div class="col-12" id="aparecen-dependientes2" style="display: <%= postulacionHogarTemporal.getTiene_mascotas() ? "block" : "none" %>;">
                                <label for="tipoMascotas" class="input-label">Tipo de mascotas (Indicar la cantidad de cada tipo)</label>
                                <input type="text" id="tipoMascotas" name="tipoMascotas" value="<%= postulacionHogarTemporal.getTipo_mascotas() %>" placeholder="">
                            </div>
                            ...
                            <div class="col-6 col-12-xsmall">
                                ...
                                <select id="viveSolo" name="viveSolo" required>
                                    <option value="">Seleccione su respuesta</option>
                                    <option value="1" <%= postulacionHogarTemporal.getTiene_dependientes() ? "selected" : "" %>>Vivo solo</option>
                                    <option value="2" <%= !postulacionHogarTemporal.getTiene_dependientes() ? "selected" : "" %>>Vivo con dependientes</option>
                                </select>
                            </div>
                            <div class="col-6 col-12-xsmall">
                                ...
                                <select id="trabajaRemoto" name="trabajaRemoto" required>
                                    <option value="">Seleccione su respuesta</option>
                                    <option value="1" <%= "Remoto".equals(postulacionHogarTemporal.getForma_trabajo()) ? "selected" : "" %>>Trabajo remoto</option>
                                    <option value="2" <%= "Presencial".equals(postulacionHogarTemporal.getForma_trabajo()) ? "selected" : "" %>>Trabajo presencial</option>
                                </select>
                            </div>
                            <div class="col-6 col-12-xsmall">
                                <label for="nombreRef" class="input-label">Nombre de persona de referencia</label>
                                <input type="text" id="nombreRef" name="nombreRef" value="<%= postulacionHogarTemporal.getNombre_persona_referencia() %>" required/>
                            </div>
                            <div class="col-6 col-12-xsmall">
                                <label for="numeroRef" class="input-label">Número de teléfono de referencia</label>
                                <input type="text" id="numeroRef" name="numeroRef" value="<%= postulacionHogarTemporal.getCelular_persona_referencia() %>" required/>
                            </div>

                            <div class="col-6 col-12-xsmall">
                                <label for="fechaInicio" class="input-label">Fecha de inicio</label>
                                <input type="date" id="fechaInicio" name="fechaInicio" value="<%= postulacionHogarTemporal.getFecha_inicio_temporal() %>" required/>
                            </div>
                            <div class="col-6 col-12-xsmall">
                                <label for="fechaFin" class="input-label">Fecha de fin</label>
                                <input type="date" id="fechaFin" name="fechaFin" value="<%= postulacionHogarTemporal.getFecha_fin_temporal() %>" required/>
                            </div>
                            ...
                            <div class="col-12">
                                ...
                                <input type="file" accept="image/png" multiple id="archivo" name="archivo" class="contenedor-archivo" disabled/>
                            </div>
                            <!-- Enviar y regresar -->
                            <div class="col-12">
                                <ul class="actions form-buttons">
                                    <li><button type="button" class="button primary big" id="confirmSubmitButton">MODIFICAR</button></li>
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        confirmSubmitButton.addEventListener('click', function() {
            ...
            if (allFieldsFilled) {
                ...
                if (confirm("¿Estás seguro de modificar tu postulación?")) {
