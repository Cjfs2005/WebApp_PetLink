    ...
    <div id="main">
        <div class="inner">
            ...
            <header id="header">
                ...
                <h1 class="logo"><strong>LISTA DE USUARIOS</strong></h1>
            </header>

            <!-- Banner con botones que abren los modales -->
            <section class="banner">
                <div class="content">
                    <p><strong>Descripción:</strong> Tabla que permite gestionar a los usuarios.</p>
                    ...
                    <div class="table-responsive">
                        <table id="example" class="table table-striped" style="width:100%;">
                            ...
                            <tr>
                                ...
                                %>
                                <td><%=formattedDate%></td>
                                <td><%=usuario.getApellidos_usuario_final()%></td>
                                <td><%=usuario.getNombres_usuario_final()%></td>
                                <td><%=usuario.getDistrito().getNombre_distrito()%></td>
                                <td>
                                    <ul class="icons">
                                        <li><a href="<%=request.getContextPath()%>/ListaUsuariosAdminServlet?action=mostrar&id=<%=usuario.getId_usuario()%>" class="icon fas fa-eye" title="Ver detalles"><span class="label">Ver detalles</span></a></li>
                                        <li><a href="#" class="icon fas fa-times-circle eliminar open-modal-update" title="Eliminar" data-id="<%=usuario.getId_usuario()%>"><span class="label">Rechazar</span></a></li>
                                    </ul>
                                </td>
                            </tr>
                            <%
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        openModalUpdateButtons.forEach(function(button) {
            button.addEventListener('click', function(event) {
                ...
                const baseUrl = "<%=request.getContextPath()%>/ListaUsuariosAdminServlet?action=eliminar";
