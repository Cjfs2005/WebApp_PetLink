                    ...
                    <form id="infoForm" method="post" action="<%=request.getContextPath()%>/ListasAdminServlet?action=actualizar">
                        <div class="row gtr-uniform">
                            <div class="col-6 col-12-xsmall">
                                ...
                                <input type="text" id="nombre" value="<%=coordinador.getNombres_coordinador()%>" required />
                            </div>
                            <div class="col-6 col-12-xsmall">
                                <label for="apellido" class="input-label">Apellidos</label>
                                <input type="text" id="apellido" value="<%=coordinador.getApellidos_coordinador()%>" required />
                            </div>
                            <div class="col-6 col-12-xsmall">
                                <label for="dni" class="input-label">DNI</label>
                                <input type="text" id="dni" value="<%=coordinador.getDni()%>" required />
                            </div>
                            <div class="col-6 col-12-xsmall">
                                <label for="telefono" class="input-label">Número de teléfono</label>
                                <input type="text" id="telefono" value="<%=coordinador.getNumero_yape_plin()%>" required />
                            </div>
                            <div class="col-12">
                                <label for="email" class="input-label">Correo Electrónico</label>
                                <input type="email" id="email" value="<%=coordinador.getCorreo_electronico()%>" required />
                            </div>
                            <div class="col-6 col-12-xsmall">
                            ...
                            <div class="col-6 col-12-xsmall">
                                ...
                                <input type="date" id="fechaNacimiento" value="<%= coordinador.getFecha_nacimiento() != null ? coordinador.getFecha_nacimiento().toString() : "" %>" required />
                            </div>
                            <div class="col-12">
    ...
    <div id="sidebar">
        <div class="inner">
            ...
            <section class="alt" id="sidebar-header">
                <img src="<%=request.getContextPath()%>/administrador/images/favicon.png" alt="Logo" id="sidebar-icon">
