...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/administrador/assets/css/ola.css">
    ...
    <div id="main">
        <div class="inner">
            ...
            <header id="header">
                ...
                <h1 class="logo"><strong>DETALLES DEL ALBERGUE</strong></h1>
            </header>
                        ...
                        <div class="col-12">
                            <ul class="actions form-buttons">
                                <li>
                                    ...
                                    <a href="<%=request.getContextPath()%>/ListaAlbergueAdminServlet?action=listar" class="button big">Regresar</a>
                                </li>
                            </ul>
                        </div>
                    </div>
...
<!-- Scripts -->
<script src="${pageContext.request.contextPath}/administrador/assets/js/jquery.min.js"></script>
<script src="${pageContext.request.contextPath}/administrador/assets/js/browser.min.js"></script>
<script src="${pageContext.request.contextPath}/administrador/assets/js/breakpoints.min.js"></script>
<script src="${pageContext.request.contextPath}/administrador/assets/js/util.js"></script>
