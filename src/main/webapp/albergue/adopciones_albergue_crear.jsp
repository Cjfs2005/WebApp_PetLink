                    ...
                    <div class="content">
                        ...
                        <div class="row gtr-uniform">
                            ...
                            <div class="col-12">
                                ...
                                <textarea id="direccionEncontrado" class="text-area" name="direccionEncontrado" maxlength="100" required></textarea>
                                <span class="charCount" id="charCountDireccion">0/100</span>
                            </div>
                            ...
                            <div class="col-12">
                                ...
                                <span class="charCount" id="charCountDescripcion">0/300</span>
                            </div>
                            ...
                            <div class="col-12">
                                ...
                                <span class="charCount" id="charCountCondiciones">0/300</span>
                            </div>
                            ...
                            <div class="col-12">
                                <ul class="actions form-buttons">
                                    ...
                                    <li><a href="javascript:history.back()" class="button big">Cancelar</a></li> <!-- Botón Cancelar -->
                                </ul>
                            </div>
