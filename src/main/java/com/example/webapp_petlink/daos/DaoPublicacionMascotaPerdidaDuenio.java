...
public class DaoPublicacionMascotaPerdidaDuenio extends DaoBase {

    // Método para obtener todas las publicaciones de los dueños con soporte de paginación y búsqueda
    ...
    // Método para actualizar el estado de una publicación (aceptar/rechazar)
    ...
    // Método para contar el total de publicaciones en la base de datos para paginación
    public int contarPublicaciones(String criterioBusqueda) {
        int total = 0;
        String query = "SELECT COUNT(*) FROM PublicacionMascotaPerdida WHERE CONCAT(nombre, celularContacto) LIKE ?";
