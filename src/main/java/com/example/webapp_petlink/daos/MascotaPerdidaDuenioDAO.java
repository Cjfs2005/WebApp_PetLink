...
public class MascotaPerdidaDuenioDAO extends DaoBase {

    /**
     * Método para listar todas las publicaciones de mascotas perdidas realizadas por dueños.
     *
     * @return Una lista de objetos PublicacionMascotaPerdida.
     */
    public List<PublicacionMascotaPerdida> listarPublicacionesDuenios() {
        ...
        String query = "SELECT p.id_publicacion_mascota_perdida, p.nombre, p.descripcion_mascota, " +
                ...
                "WHERE p.id_tipo_publicacion_mascota_perdida = 1"; // Tipo 1: Publicaciones de dueños
