...
import com.example.webapp_petlink.daos.PublicacionMascotaPerdidaUsuarioDAO;
...
@WebServlet(name = "PublicacionMascotaPerdidaUsuarioServlet", value = "/PublicacionMascotaPerdidaUsuarioServlet")
public class PublicacionMascotaPerdidaUsuarioServlet extends HttpServlet {

    @Override
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        String accion = request.getParameter("accion");
        PublicacionMascotaPerdidaUsuarioDAO dao = new PublicacionMascotaPerdidaUsuarioDAO();
        ...
        if ("listar".equals(accion)) {
            ...
            List<PublicacionMascotaPerdida> publicaciones = dao.listarPublicacionesDeUsuarios();
